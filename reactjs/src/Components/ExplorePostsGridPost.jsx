...
export const ExplorePostsGridPost = ({ image, postId }) => {
    return (
                    ...
                    <motion.div className="animate__animated animate__fadeIn img-wrap" layout>
                        { image[ image.length - 1 ] === "4" ? 
                            <>  
                                ...
                                <svg className="absolute animate__animated animate__fadeIn animate__faster right-4 top-3 z-10" color="#ffffff" fill="#ffffff" height="20" role="img" viewBox="0 0 48 48" width="20">
