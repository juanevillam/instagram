...
export const Register = () => {
    ...
    document.title = "Register • The Instagram Clone • By Juan Villa";
    const [ formValues, handleInputChange ] = useForm({ fullName: "", email: "", password: "" });
    ...
    const register = ( e ) => handleRegister( e, email, password, fullName, dispatch, setError, removeError );
                ...
                <div className="flex flex-col lg:px-14 pt-5 px-8 xl:px-24">
                    ...
                    <div className="pb-6 pt-6">
                        ...
                        <span className="animate__animated animate__fadeIn font-light text-gray-500 text-sm">
                            Register now to share and enjoy more.
                        </span>
                        <form onSubmit={ register }>
                            ...
                            <div className="flex pt-6 space-x-6">
                                <div>
                                    <label className="animate__animated animate__fadeIn font-light" htmlFor="name">Full name</label>
                                    <div className="animate__animated animate__fadeIn border border-gray-400 duration-300 flex focus-within:border-orange-500 focus-within:shadow-lgOrange items-center mt-2 overflow-hidden rounded-lg transition w-full" >
                                        <div className="flex items-center justify-center pl-3">
                                            <LockIcon className="h-6 pointer-events-none w-6" />
                                        </div>
                                        <input className="border-0 focus:outline-none focus:ring-0 font-light px-4 py-4.5 w-full" id="fullName" name="fullName" onChange={ handleInputChange } placeholder="Enter your full name" required type="name" value={ fullName } />
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className="pt-8">
                                <button className="animate__animated animate__fadeIn bg-pink-500 duration-300 focus:outline-none focus:ring-4 focus:ring-red-100 hover:bg-pink-600 py-4 px-8 rounded-lg shadow-lg text-white transition w-full" onClick={ register } type="submit">
                                    Register
                                </button>
                            </div>
                        </form>
                        <div className="pt-4">
                            <div className="animate__animated animate__fadeIn  font-light text-center text-gray-500">
                                ...
                                <NavLink className="animate__animated animate__fadeIn  font-normal duration-300 hover:text-orange-600 hover:underline ml-2 text-orange-500 transition" to="/auth/login">
                                    Log In
                                </NavLink>
                            </div>
